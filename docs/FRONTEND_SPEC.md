...
| From | To |
|---|---|
| SUBMITTED | NEED_APPROVAL / DISPATCHING / REJECTED / CANCELLED |
| NEED_APPROVAL | DISPATCHING / REJECTED / CANCELLED |
| DISPATCHING | ACCEPTED / CANCELLED / FAILED / EXPIRED |
| ACCEPTED | ASSIGNED / CANCELLED |
| ASSIGNED | EN_ROUTE / CANCELLED |
| EN_ROUTE | ARRIVED / CANCELLED |
| ARRIVED | WORKING / CANCELLED |
| WORKING | OTP_PENDING / FAILED / CANCELLED |
